...
- Tuned XGBoost test metrics: **roc_auc=0.7731, pr_auc=0.7119, precision=1.0000, recall=0.0920, f1=0.1684**

## 3. ChEMBL Ablation
- With ChEMBL: **roc_auc=0.7731, pr_auc=0.7119, precision=1.0000, recall=0.0920, f1=0.1684**
- Without ChEMBL: **roc_auc=0.7804, pr_auc=0.6979, precision=0.9143, recall=0.0742, f1=0.1373**
...
## 5. Safety Validation
- Random-split hazard precision / recall: **1.0000 / 0.0920**
- Random-split validated coverage: **0.9771**
- Scaffold-split hazard precision / recall: **0.8478 / 0.1018**
- Scaffold-split validated coverage: **0.9614**
